...
//        CarState state = new CarState("Hello-World",alice.getParty(),bob.getParty());
//        ledger(ledgerServices, l -> {
//            l.transaction(tx -> {
//                tx.input(CarStateContract.ID, state);
//                tx.output(CarStateContract.ID, state);
//                tx.command(alice.getPublicKey(), new CarStateContract.Commands.Send());
